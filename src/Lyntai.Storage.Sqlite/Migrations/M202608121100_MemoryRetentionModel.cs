...
public sealed class M202608121100_MemoryRetentionModel : Migration
{
    public override void Up()
    {
        ...
        // Steers LINKING, never recall. Deliberately its own table rather than extra searchable text on the
        // node: appending subjects to the content index would let the existing seed path find them with no
        // new code at all, and would silently change what every ordinary recall matches — a far larger blast
        // radius than linking needs.
        //
