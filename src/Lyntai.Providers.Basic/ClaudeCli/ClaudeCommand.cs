...
/// <see cref="CliProviderEngine"/>, which resolves via its backend). Keeps this package's env precedence —
...
{
    /// <summary>The backend is the SINGLE declaration of this CLI's default command and env seams — reading
