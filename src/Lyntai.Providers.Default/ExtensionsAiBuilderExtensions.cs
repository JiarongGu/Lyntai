...
// Lives in the Lyntai namespace so `AddExtensionsAi` shows up right on the builder.
namespace Lyntai;
...
public static class ExtensionsAiBuilderExtensions
{
    ...
    public static LyntaiBuilder AddExtensionsAi(this LyntaiBuilder builder, string id, IChatClient client) =>
        builder.AddExtensionsAi(id, _ => client);
    ...
    public static LyntaiBuilder AddExtensionsAi(this LyntaiBuilder builder, string id,
