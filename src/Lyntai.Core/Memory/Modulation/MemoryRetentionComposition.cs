...
/// <see cref="ModulatedRetrievability"/> applies, so the combination rule is a swappable decision rather
/// than a hardcoded line inside that class.
...
/// <see cref="MultiplicativeRetentionCompositionPolicy"/> reduces an empty list to 1 (no widening at all) and
/// a one-element list to that element's own value.</para>
/// </summary>
...
/// of what the others already bought", the same reading <see cref="ModulatedRetrievability"/>'s own
