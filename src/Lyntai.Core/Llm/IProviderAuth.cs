...
/// collection, like <see cref="IModelProvider"/> / <see cref="IProviderUpdater"/>: a backend with
...
public interface IProviderAuth
{
    ...
    /// caller that must distinguish them should ask <see cref="IModelProvider.ProbeAsync"/> first —
...
/// <see cref="IModelProvider.ProbeAsync"/> distinguishes them properly.</param>
