...
// Lives in the Lyntai namespace so `AddLlamaSharp` shows up right on the builder.
namespace Lyntai;
...
public static class LocalBuilderExtensions
{
    ...
    public static LyntaiBuilder AddLlamaSharp(this LyntaiBuilder builder, string modelPath,
