...
|---|---|---|---|---|---|
| 2026-09-23 | The next release: pre-release review of `v3.2.0..HEAD` and the regular wide check — a session plan | unreleased — executed 2026-09-23 | — | ✓ | `docs/task-archive.md` Part 279; the two rulings in **D161**; the file rule in **D171**; `docs/FIXES.md` 2026-09-23 (two entries); the dependency ruling left open as `TASKS.md` Part 280 |
