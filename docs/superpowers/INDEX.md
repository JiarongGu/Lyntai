...
|---|---|---|---|---|---|
| 2026-09-17 | The namespace restructure: one home for calling a backend | not started | ✓ | — | `TASKS.md` Part 103 (NS-1…NS-5, sequenced — the ORDER is the point) · the five measured problems, including `Lyntai.Lifecycle` being a third lifecycle and `Lyntai.Providers` meaning three things |
