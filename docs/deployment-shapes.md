...
- **A static embedder is the only option that contends for nothing at all**, and on the MEMORY workload it
  ...
  arm". **Both in-process embedders now ship** — `AddModel2Vec` (**D121**) and `AddOnnx`
