...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D135** — read its generated index table
...
**MEASURED with Docker up, re-attested 2026-09-14 at `de37e05`** — read off that run's own output, never
