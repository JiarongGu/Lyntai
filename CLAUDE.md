...
**The baseline a green run should match:** `5092 passed / 5139 total, 47 skipped` (every skip is a
live-backend gate), e2e 3/3, guard-script tests 960/960, doc samples 55/55 — MEASURED with Docker up at
`d077c2b9` (2026-09-26). No gate holds the xUnit trio (`docs/GATES.md` §Which numbers a gate holds), so:
