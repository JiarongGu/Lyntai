...
**Released: v3.5.0 (2026-09-26).** Eleven packages. The public API is frozen under
...
**The baseline a green run should match:** `5223 passed / 5270 total, 47 skipped` (every skip is a
live-backend gate), e2e 3/3, guard-script tests 960/960, doc samples 57/57 — MEASURED with Docker up at
`d4475f23` (2026-09-27). No gate holds the xUnit trio (`docs/GATES.md` §Which numbers a gate holds), so:
