...
**Released: v3.1.0 (2026-08-23).** Thirteen packages; public API frozen under SemVer 2.0 since 1.0, with no
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D121** — read its generated index table
