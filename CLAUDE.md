...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D128** — read its generated index table
...
**The baseline a green run should match:** `3706 passed / 3735 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-14 at `0df32ca`** — read off that run's own output, never
