...
**The baseline a green run should match:** `3730 passed / 3759 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-15 at `9c4a1e6c`** — read off that run's own output, never
