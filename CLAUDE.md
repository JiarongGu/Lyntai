...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D142** — read its generated index table
...
**MEASURED with Docker up, re-attested 2026-09-15 at `ee382ea`** — read off that run's own output, never
