...
**The baseline a green run should match:** `3727 passed / 3756 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-15 at `d4eacc0`** — read off that run's own output, never
