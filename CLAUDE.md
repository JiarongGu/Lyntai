...
The reasoning is `docs/DECISIONS.md`, **D1–D109**. The two groups worth knowing before you touch anything:
...
Tests/e2e green: **3570 passed / 3591 total, 21 skipped** (live-backend only — Ollama, MCP, a real CLI, a
real annotating/judging model, a real embedder), e2e 3/3, guard-script tests 495/495, doc samples 80/80.
