...
**The baseline a green run should match:** `5019 passed / 5060 total, 41 skipped` (every skip is a
live-backend gate), e2e 3/3, guard-script tests 960/960, doc samples 55/55 — MEASURED with Docker up at
`f6e5a257` (2026-09-26). No gate holds the xUnit trio (`docs/GATES.md` §Which numbers a gate holds), so:
