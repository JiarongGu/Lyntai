...
**The baseline a green run should match:** `3721 passed / 3750 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-15 at `cd4fd70`** — read off that run's own output, never
