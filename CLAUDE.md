...
**The baseline a green run should match:** `4945 passed / 4986 total, 41 skipped` (every skip is a
live-backend gate), e2e 3/3, guard-script tests 955/955, doc samples 54/54 — MEASURED with Docker up at
`9bb72aca` (2026-09-26). No gate holds the xUnit trio (`docs/GATES.md` §Which numbers a gate holds), so:
