...
**The baseline a green run should match:** `4629 passed / 4670 total, 41 skipped` (the skips are
live-backend only), e2e 3/3, guard-script tests 950/950, doc samples 62/62. **The xUnit trio is held by no
...
**MEASURED with Docker up, re-attested 2026-09-25 at `78946f34`** (+100 passed against `d1b4fc77`: archive
Parts 291–292 — GEN7's mesh stage and its hardening, ComfyUI execution errors, the durable pipeline job; skipped
+1, the live-gated ComfyUI mesh chain; +61 before that, against `5b1e4afd`: archive Part 289 —
...
44 for the live route and its async capability probe, 21 for the final review's fixes; +13 before that,
archive Part 285 — the 13 `MemoryWriteResultTests` facts; +13 before that, archive Part 283 — 3 journal, 1 cross-engine restart,
9 skip-logging; +117 before that, the file-system graph store, archive
