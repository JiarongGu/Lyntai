...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D140** — read its generated index table
...
**The baseline a green run should match:** `3743 passed / 3772 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-15 at `03b8634`** — read off that run's own output, never
