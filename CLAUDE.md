...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D130** — read its generated index table
...
**The baseline a green run should match:** `3716 passed / 3745 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-14 at `5b266f2`** — read off that run's own output, never
