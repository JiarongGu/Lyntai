...
The reasoning is `docs/DECISIONS.md`, **D1–D107**. The two groups worth knowing before you touch anything:
...
Tests/e2e green: **3565 passed / 3586 total, 21 skipped** (live-backend only — Ollama, MCP, a real CLI, a
