...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D134** — read its generated index table
...
**MEASURED with Docker up, re-attested 2026-09-14 at `9d634b5`** — read off that run's own output, never
