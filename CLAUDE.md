...
**The baseline a green run should match:** `4929 passed / 4970 total, 41 skipped` (every skip is a
live-backend gate), e2e 3/3, guard-script tests 955/955, doc samples 54/54 — MEASURED with Docker up at
`21cb38bc` (2026-09-26). No gate holds the xUnit trio (`docs/GATES.md` §Which numbers a gate holds), so:
