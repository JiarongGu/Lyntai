...
**The baseline a green run should match:** `3718 passed / 3747 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-15 at `31371d0c`** — read off that run's own output, never
