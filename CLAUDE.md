...
The reasoning is `docs/DECISIONS.md`, **D1–D106**. The two groups worth knowing before you touch anything:
...
Tests/e2e green: **3560 passed / 3581 total, 21 skipped** (live-backend only — Ollama, MCP, a real CLI, a
