...
carve-out (**D70**). The reasoning is `docs/DECISIONS.md`, **D1–D136** — read its generated index table
...
**The baseline a green run should match:** `3722 passed / 3751 total, 29 skipped` (the skips are
...
**MEASURED with Docker up, re-attested 2026-09-14 at `5a80e2e`** — read off that run's own output, never
