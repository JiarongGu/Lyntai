...
The reasoning is `docs/DECISIONS.md`, **D1–D91**. The two groups worth knowing before you touch anything:
**D83–D91 are post-3.0** — mostly additive, every one from a seam an adopting application had to work around
...
overall is **D39–D41**, **D45–D63**, **D72**, **D76–D79**, **D83–D86**, **D88**, **D89**, **D90** and **D91**.
...
Tests/e2e green: **3367 passed / 3388 total, 21 skipped** (live-backend only — Ollama, MCP, a real CLI, a
