...
/// dialect class rather than a re-implementation of these invariants.
///
...
public class CliProviderEngineTests
{
    ...
    public async Task A_reported_failure_wins_over_a_NONZERO_exit_and_its_stderr_chatter()
    {
        ...
        // backend's own account of the failure. MEASURED on codex-cli 0.146.0 (an expired login):
    ...
    public async Task A_nonzero_exit_with_NO_reported_failure_still_reports_the_exit_and_its_stderr()
    {
        ...
        // stderr are all there is, and they must still be reported
